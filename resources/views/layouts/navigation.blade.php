<nav x-data="{ showSearchBar: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
    ...
    <div class="max-w-7xl mx-auto px-4 px-6 lpx-8">
        <div :class="{'space-x-3': !showSearchBar }" class="flex justify-between h-16 space-x-3">
            <div :class="{'hidden': showSearchBar }"  class="flex space-x-3">
                ...
                <div @click="$dispatch('toggle-sidebar')" class="hamburger -me-2 flex items-center">
